...
class MultiSigABTxForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['#attached']['library'][] = 'qls_ss9/multi_sig_abtx';


    $form['description'] = [
      '#type' => 'item',
      '#markup' => $this->t('9.3.2 アグリゲートボンデッドトランザクションで送信'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // \Drupal::logger('qls_ss9')->info('Aggregated Bounded TxHash: @TxHash', ['@TxHash' => $facade->hashTransaction($aggregateTx)]);
